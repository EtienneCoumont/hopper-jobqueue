...
The project source, including a 700-line design brief with every decision spelled out,
lives in the [GitHub repository](https://github.com/EtienneCoumont/hopper-jobqueue).
